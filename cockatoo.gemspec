...
Gem::Specification.new do |s|
  ...
  s.description = %q{Cockatoo is a chat server built using EventMachine and using the Long Polling technique}
  s.email = %q{yann.klis @nospam@ novelys.com}
  s.executables = ["cockatoo"]
  s.extra_rdoc_files = ["bin/cockatoo", "lib/cockatoo_daemon.rb", "lib/cockatoo_http_server.rb"]
  s.files = ["Manifest", "Rakefile", "bin/cockatoo", "cockatoo.gemspec", "lib/cockatoo_daemon.rb", "lib/cockatoo_http_server.rb"]
  s.homepage = %q{http://github.com/novelys/cockatoo}
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Cockatoo"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{cockatoo}
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{Cockatoo is a chat server}
